      ...
      for (int row = 0; row < 6; row++)
        ...
        children: List.generate(7, (col) {
          ...
          return InkWell(
            onTap: () {
              if (isToday) {
                Text('Selected: ${DateFormat('yyyy-MM-dd').format(day)}');
              }
            },
            child: Container(
              height: 50,
              ...
              decoration: BoxDecoration(
                color: isToday ? Colors.deepPurple : (isCurrentMonthDay ? null : Colors.deepPurple[100]),
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: isCurrentMonthDay ? (isToday ? Colors.white : Colors.black) : Colors.grey[700],
                  fontSize: 15,
                ),
              ),
            ),
